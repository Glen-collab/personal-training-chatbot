...
**I am curious:** What has been your biggest struggle with weight loss in the past - staying motivated, finding time, or dealing with stress eating? I have specific strategies for each challenge!"""
    ...
    if any(word in query_lower for word in ["when to eat", "meal timing", "how often eat", "when should i eat"]):
        return """**My meal timing and planning approach: Eat every 3 to 4 hours with strategic planning.**
...
def add_strategic_followup(response_text: str, query: str) -> str:
    ...
    # Do not add follow-ups to responses that already have questions
    ...
    if any(word in query_lower for word in ["eat", "food", "nutrition", "diet", "meal", "calories", "protein"]):
        followup_questions = [
            "What is your biggest nutrition challenge right now - meal prep, eating out too much, or late-night snacking?",
            "Are you dealing with stress eating, or do you struggle more with finding time to cook healthy meals?",
            "What has been your biggest obstacle to eating consistently - busy schedule, family preferences, or knowing what to cook?",
    ...
    # Exercise/Training related
        ...
        followup_questions = [
            "What is your biggest barrier to consistent workouts - time constraints, motivation, or not knowing what to do?",
            "Do you struggle more with finding time to exercise, or staying motivated when you do have time?",
            "What has been your biggest challenge with fitness - sticking to a routine, seeing results, or dealing with injuries?",
    ...
    # Weight loss related
        ...
        followup_questions = [
            "What has been your biggest weight loss obstacle - staying motivated, dealing with plateaus, or managing stress eating?",
            ...
            "What is your biggest frustration - slow progress, lack of energy, or feeling overwhelmed by all the conflicting advice?"
        ]
    
    # Motivation/Psychology related
    elif any(word in query_lower for word in ["motivation", "mindset", "stress", "habit", "goal", "struggle"]):
        followup_questions = [
            "What is the biggest thing that kills your motivation - setbacks, comparing yourself to others, or feeling overwhelmed?",
            "Do you struggle more with starting new habits, or maintaining them once you get going?",
            "What is your biggest source of stress that impacts your health goals - work, family, or financial pressures?",
            "Are you dealing with perfectionism that holds you back, or more with inconsistency and starting over?",
            "What has been your pattern with past goals - starting strong then fading, or never quite getting started?"
        ]
    
    # Hydration/Water related
    elif any(word in query_lower for word in ["water", "drink", "hydration"]):
        followup_questions = [
            "What is your biggest hydration challenge - remembering to drink water, or just not liking the taste of plain water?",
    ...
    # General/Other topics
        ...
        followup_questions = [
            "What is your main health and fitness goal right now - losing weight, building strength, or just feeling better overall?",
            "What has been your biggest challenge in reaching your fitness goals - time, motivation, or knowing what to do?",
    ...
    # Add the follow-up in Glen conversational style
    return f"{response_text}\n\n**Let me ask you this:** {followup} I have got specific strategies for whatever you are dealing with!"

def add_glen_personality(response_text: str) -> str:
    """Add Glen personal touch to responses - but avoid repetition"""
    
    # Only add personality if response does not already have Glen voice
    if "glen" in response_text.lower() or "my" in response_text.lower() or "i have" in response_text.lower():
        return response_text  # Already has personality, do not add more
    ...
    if "protein" in response_text.lower() and "blood work" not in response_text.lower():
        ...
        response_text += "\n\n*From my 25+ years of working with people, I have learned that mindset is often the missing piece.*"
    
    elif "training" in response_text.lower() or "exercise" in response_text.lower():
        if "3:30" not in response_text.lower():
...
def format_glen_response(results: List[Dict[str, Any]], query: str = "") -> str:
    ...
    if st.session_state.get(exhausted_key, False):
        # Topic exhausted - give Glen "enough already" message
        exhausted_responses = [
            "Alright, alright! I think you have gotten all my wisdom on this topic. Time to take action - pick a different question or actually DO something with what I have told you!",
            "Hey, we have covered this ground pretty thoroughly! How about we talk about something else, or better yet, go apply what you have learned? Action beats analysis paralysis every time!",
            "I have given you everything I have got on this one! Time to stop clicking buttons and start lifting weights. What else can I help you with?",
            "You have officially exhausted my knowledge bank on this topic! That means it is time to stop researching and start doing. What is your next move going to be?",
            "Okay, you have definitely gotten your money worth on this subject! Time to take action instead of asking the same question fifty different ways. What else is on your mind?"
        ]
        
        return f"{random.choice(exhausted_responses)}\n\n**Let me ask you this:** What is holding you back from actually implementing what you have learned? I have got strategies to get you moving!"
    
    # If no results, proceed with encouraging response
    if not results:
        encouraging_responses = [
            "Let us tackle this together! Even if that specific topic is not in my current materials, I have helped thousands of people with similar challenges.",
            ...
            "I love that you are asking the tough questions! That is exactly the mindset that leads to real transformation.",
            "You know what? That is the kind of question that shows you are ready to make real changes. Let us dive deeper into what is really going on."
        ]
        
        solution_focused_options = [
            "Here is what I always tell my clients: the best answers come from understanding YOUR specific situation.",
            "After 25+ years of coaching, I have learned that every person journey is unique - let us figure out yours.",
            "The fact that you are asking shows you are ready to take action. That is half the battle right there!",
            "I have seen this pattern before - when someone asks questions like this, they are usually closer to a breakthrough than they think."
        ]
        
        action_oriented_closers = [
            "Let us start with what is working and what is not working for you right now.",
            "Tell me more about your specific situation and I will give you a roadmap.",
            "What is your biggest frustration with your current approach? I have got solutions.",
            "Let us get specific about your goals and obstacles - that is where the magic happens."
        ]
        
        base_response = f"{random.choice(encouraging_responses)} {random.choice(solution_focused_options)}"
        
        actionable_topics = [
            "**🎯 Your Weight Loss Goals** - What is your target and timeline?",
            "**💪 Your Current Routine** - What is working and what is not?", 
        ...
        response += f"\n**Here is what I know for sure:** Every successful transformation starts with understanding where you are right now. {random.choice(action_oriented_closers)}"
...
def main():
    ...
    with col2:
        ...
        if st.session_state.calculated_results:
            ...
            if st.button("🗑️ Clear Results", key="clear_calc_sidebar"):
                st.session_state.calculated_results = None
                st.rerun()
...
def display_header_with_logo():
    ...
    if logo_base64:
        ...
        <div class="logo-container">
            <img src="data:{mime_type};base64,{logo_base64}" class="logo" alt="Glen Logo">
        </div>
        ''', unsafe_allow_html=True)
    else:
...
def display_glen_quote():
    ...
    quotes = [
        "If you are five minutes early, you are 10 minutes late. Marine Corps wisdom that drives my training",
        "Consistency beats perfection every time. After 17 years, I have learned this is the key to lasting transformation.",
        "Protein is king for muscle repair and metabolism. My blood tests prove it is safe and effective.",
        ...
        "I train at 3:30 am because consistency builds habits, and habits build character.",
        "Your mind is your most powerful muscle. That is what 25 years of client work has taught me."
    ]
...
def show_calorie_calculator():
    """Display interactive calorie calculator with Glen explanations"""
    st.markdown("### 🧮 **Glen Personal Calorie Calculator**")
    
    # Add Glen explanations for BMR and TDEE
    with st.expander("📚 **What are BMR and TDEE? (Click to learn)**", expanded=False):
        st.markdown("""
        ### 🔥 **BMR (Basal Metabolic Rate)**
        Your BMR is the number of calories your body burns just to stay alive - breathing, heart beating, brain functioning, cell repair. Think of it as your body idle speed.
        
        **Glen take:** "Even if you laid in bed all day, you would still burn your BMR calories. It is usually 60-70% of your total daily burn. This is why crash diets are stupid - you cannot go below your BMR for long without your body fighting back."
        ...
        **Glen experience:** "After 25+ years of coaching, I have learned that most people underestimate their activity level. Be honest about your real lifestyle, not what you wish it was. That is how you get accurate numbers that actually work."
        ...
        **My recommendation:** Start 500 calories below your TDEE for steady 1 lb/week loss. It is sustainable and you will not feel like you are starving.
        """)
    ...
    if st.button("🔥 Calculate My Numbers", type="primary", use_container_width=True):
        ...
        with col3:
            st.metric("🍖 Protein Target", f"{results['protein_grams']} g/day",
                     help="Glen rule: 1g per pound bodyweight")
        
        st.markdown("---")
        st.markdown("### 📊 **Glen Weight Loss Plan for You:**")
        ...
        with loss_col1:
            ...
            **Glen says:** "This is my sweet spot. You will lose weight consistently without feeling deprived. Most of my successful clients start here."
            """)
        ...
        with loss_col2:
            ...
            **Glen warning:** "Only do this if you are highly motivated and can stick to it. Most people burn out on aggressive cuts."
            """)
        
        st.markdown("---")
        st.info(f"""
        ### 💪 **Glen Complete Plan for You:**
        ...
        **Glen reality check:** "These numbers are your starting point. Every body responds differently. Give it 2-3 weeks, then adjust based on your results. I have been doing this for 25+ years - trust the process!"
        """)
...
def get_quick_answer(query: str) -> str:
    ...
    if any(word in query_lower for word in ["carb", "carbs", "carbohydrates", "how many carbs", "how much carbs"]):
        if st.session_state.get('calculated_results'):
            ...
            tdee = results['tdee']
            return f"""**My carb rule: Aim for 1.2 grams per pound of body weight for balanced energy.**
...
**Let me ask you:** Are you struggling with energy crashes or carb confusion? I have strategies for both!"""
            ...
            st.session_state.show_calculator = True
            return """**Carbs depend on your body and goals, so let us get specific!**
...
**Follow-up question for you:** Are you currently trying to lose weight, or are you more focused on building muscle and strength? I can give you more specific advice based on your goals!"""
    ...
    if any(word in query_lower for word in ["exercise", "workout", "train", "how often", "how many times"]):
        return """**My training philosophy: 3 to 4 days per week, consistently.**
...
**Tell me:** What is your biggest obstacle to working out consistently - time, motivation, or not knowing what to do? I have helped thousands overcome each of these!"""
    ...
    if any(word in query_lower for word in ["lose weight", "weight loss", "how long", "how fast"]):
        return """**Realistic weight loss: 1 to 2 pounds per week.**
...
**Remember:** You did not gain it overnight, you will not lose it overnight
...
**Let me ask you this:** Do you struggle more with planning your meals for the week, or actually sticking to the plan once you make it? I've got specific solutions for both challenges!"""
    ...
    if 'water_answer' in locals():
        return water_answer
    if 'exercise_answer' in locals():
        return exercise_answer
    if 'weightloss_answer' in locals():
        return weightloss_answer
    if 'mealtiming_answer' in locals():
        return mealtiming_answer
